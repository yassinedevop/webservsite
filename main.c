...
//	int sockfd , sockfd2 , port = 1233;
//	struct sockaddr_in adress,remote;
//	char *request;
//
...
//
//	if(bind(sockfd, (struct sockaddr *)&adress,sizeof(adress))<0)
...
//			"<style> body{background : tomato;} h1{ text-align : center; color:white; font-size : 46px;} </style></head>"
//			"<body><h1>say hello</h1><h2>IT WORKS !!</h2></body></html>";
////	char buffer[]="HTTP/1.1 200 OK\r\n"
////				"Content-Type: text/html; charset=UTF-8\r\n\r\n"
////				"<!DOCTYPE html><html><head><canvas id =\"yeah\" height=\"1080\" width=\"1920\"></canvas><script type=\"text/javascript\" src=\"jquery.js\"></script>"
////	"<script type=\"text/javascript\" src=\"jcanvas.js\"></script>"
////	"<script type=\"text/javascript\" src=\"photochanger.js\"></script>"
////	"<script type=\"text/javascript\" src=\"moussie/mouse.js\"></script>"
////	"<link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\">"
////	"<title>premier</title></head><body><h1>WEB SERVER</h1>"
////"<p>This web server was created by two students in their PFE</p><div id=\"countainer\">"
////	"<div class=\"greenland\" id=\"img1\"><a href=\"site.html\">"
////	"<p title = \"supervise the I/O of the board\">Controlling FPGA</p></a> </div>"
////"<div class=\"greenland\"  id=\"img2\"><a href=\"game.html\">"
////		"<p title =\"play a multiplayer game with your friends\">GAME</p></a></div>"
////"<div class=\"greenland\" id=\"img3\"><a href=\"#\">"
////		"<p title=\"a tiny chat server with a lot of functionnalities\">CHAT</p></a>"
////	"</div><div class=\"greenland\" id=\"img4\"><a href=\"#\">"
////		"<p title=\"upload images documents and more\">Upload files</p></a>"
////	"</div><div class=\"greenland\" id=\"img5\"><a href=\"#\">"
////		"<p title=\"click here to know more about the project and source codes\">about devs</p></a></div>"
////	"<div class=\"bigdiv\" id=\"old\"></div></div></body></html>";
//
//	while(1){
//
//		bzero(request , 50);
//		sockfd2 = accept(sockfd  , (struct sockaddr *)&remote ,  &size);
//
//		read(sockfd2 ,(void *) request , strlen(request), 0);
//
//		if(sockfd2 >= 0){
